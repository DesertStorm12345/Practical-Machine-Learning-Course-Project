...
Accuracy for Random Forest model was 0.994 (95% CI: (0.992, 0.996)) compared to 0.758 (95% CI: (0.748, 0.767)) for Decision Tree model. The random Forest model is choosen. The accuracy of the model is 0.994. Our Test data set comprises 20 cases. With an accuracy above 99% on our cross-validation data, we can expect that very few, or none, of the test samples will be missclassified.
